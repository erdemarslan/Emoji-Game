...
class VC_Level11_12: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        imageList.append(img8)
        imageList.append(img9)
        imageList.append(img10)
        imageList.append(img11)
        imageList.append(img12)
        imageList.append(img13)
        imageList.append(img14)
        imageList.append(img15)
        imageList.append(img16)
        imageList.append(img17)
        imageList.append(img18)
        imageList.append(img19)
        imageList.append(img20)
        imageList.append(img21)
        imageList.append(img22)
        imageList.append(img23)
        imageList.append(img24)
        imageList.append(img25)
        imageList.append(img26)
        imageList.append(img27)
        imageList.append(img28)
        imageList.append(img29)
